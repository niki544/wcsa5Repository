...
public class UsersPage {
	...
	@FindBy(xpath="//input[@value='Create New User']")  private WebElement  userListCreateNewUser;
	@FindBy(name="username")  private WebElement  usnTB;
	@FindBy(name="passwordText")  private WebElement  pssTB;
	...
	public WebElement getUserListCreateNewUser() {
		return userListCreateNewUser;
	}
